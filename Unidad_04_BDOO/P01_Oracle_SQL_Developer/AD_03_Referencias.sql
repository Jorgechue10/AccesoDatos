...
INSERT INTO EMPLEADOS_DEPT VALUES  (1, 'Chueca', 1500, (SELECT REF(D) FROM TABLA_DEPT D
WHERE D.DEPT_NUM = 1));

INSERT INTO EMPLEADOS_DEPT VALUES  (2, 'Tutor', 1300, (SELECT REF(D) FROM TABLA_DEPT D
WHERE D.DEPT_NUM = 2));

INSERT INTO EMPLEADOS_DEPT VALUES  (3, 'San Esteban', 1800, (SELECT REF(D) FROM TABLA_DEPT D
WHERE D.DEPT_NUM = 3));

INSERT INTO EMPLEADOS_DEPT VALUES  (4, 'Bruna', 2000, (SELECT REF(D) FROM TABLA_DEPT D
WHERE D.DEPT_NUM = 4));

--También se puede insertar poniendoo el departamento como nulo y después actualizarlo
INSERT INTO EMPLEADOS_DEPT VALUES  (5, 'Lainez', 1500, NULL);

UPDATE EMPLEADOS_DEPT E SET DEPT = (SELECT REF(D) FROM TABLA_DEPT D
WHERE D.DEPT_NUM = 5) WHERE E.EMP_NUM = 5;
